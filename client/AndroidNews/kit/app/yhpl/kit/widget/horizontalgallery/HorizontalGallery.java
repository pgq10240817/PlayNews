package app.yhpl.kit.widget.horizontalgallery;
...
import app.yhpl.kit.utils.ABAppUtil;
import app.yhpl.kit.utils.ABViewUtil;

/**
 * Author: wangjie Email: tiantian.china.2@gmail.com Date: 11/13/14.
 */
...
public class HorizontalGallery extends HorizontalScrollView implements View.OnClickListener {
	...
	private void initData() {
		...
		for (int i = 0; i < itemCount; i++) {
			...
			if (itemWidth <= 0) {
				...
				Logger.d(TAG, "itemWidth: " + itemWidth + ", hgLength: " + hgLength + ", screenItemCounts: "
						+ screenItemCounts);
			}
		}
		setSelected(0);
	...
	public void setOnHorizontalGalleryItemSelectedListener(
			OnHorizontalGalleryItemSelectedListener onHorizontalGalleryItemSelectedListener) {
