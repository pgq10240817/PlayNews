...
public class SheetDialog extends Dialog implements AdapterView.OnItemClickListener {
	...
	public static Dialog createVerticalMenu(Context context, int itemSelectorBg, String title, String cancel,
			String[] items, OnVertMenuItemClickListener listener) {
	...
	public SheetDialog(Context context, int itemSelectorBg, String title, String cancel, String[] items,
			OnVertMenuItemClickListener listener) {
		super(context, R.style.customDialogStyle);
