package app.yhpl.kit.widget.verticalmenu;
...
/**
 * ios中的Sheet风格对话框 Created with IntelliJ IDEA. Author: wangjie
 * email:tiantian.china.2@gmail.com Date: 13-11-27 Time: 下午4:46
 */
public class SheetComplexDialog extends Dialog implements AdapterView.OnItemClickListener {
	 ...
	 * 
	 * @param context
	 * @param itemSelectorBg
	 *            如果是大于小于0，则使用默认的点击背景效果
	 * @param title
	 * @param cancel
	 * @param items
	 * @param listener
	 * @return
	 */
	public static Dialog createVerticalMenu(Context context, int itemSelectorBg, String title, String cancel,
			List<SheetItem> items, OnSheetComplexDialogListener listener) {
		SheetComplexDialog verticalMenu = new SheetComplexDialog(context, itemSelectorBg, title, cancel, items,
				listener);
		return verticalMenu;
	}
	...
	public SheetComplexDialog(Context context, int itemSelectorBg, String title, String cancel, List<SheetItem> items,
			OnSheetComplexDialogListener listener) {
