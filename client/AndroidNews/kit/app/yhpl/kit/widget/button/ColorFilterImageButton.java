package app.yhpl.kit.widget.button;
...
/**
 * 图片按钮，如果按下，则会改变图片颜色、亮度、透明度等 Author: wangjie Email: tiantian.china.2@gmail.com
 * Date: 12/31/14.
 */
public class ColorFilterImageButton extends ImageButton {
	...
	private void init(Context context) {
		...
		matrix.set(new float[] { matrixVector.red, 0, 0, 0, matrixVector.brightness, 0, matrixVector.green, 0, 0,
				matrixVector.brightness, 0, 0, matrixVector.blue, 0, matrixVector.brightness, 0, 0, 0,
				matrixVector.alpha, 0 });
	}
	...
	class MatrixVector {
		...
		public String toString() {
			return "MatrixVector{" + "red=" + red + ", green=" + green + ", blue=" + blue + ", alpha=" + alpha
