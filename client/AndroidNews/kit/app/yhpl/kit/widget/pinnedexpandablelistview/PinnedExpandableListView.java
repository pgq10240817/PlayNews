package app.yhpl.kit.widget.pinnedexpandablelistview;
...
public class PinnedExpandableListView extends ExpandableListView implements OnScrollListener, OnGroupClickListener {
	...
	protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
		...
		int state = groupPos < 0 || childPos < 0 ? PinnedExpandableHeaderAdapter.PINNED_HEADER_VISIBLE : mAdapter
				.getPinnedExpandableHeaderState(groupPos, childPos);
	...
	public void configureHeaderView(int groupPosition, int childPosition) {
		...
		// int state = mAdapter.getPinnedExpandableHeaderState(groupPosition,
		// childPosition);
		int state = groupPosition < 0 || childPosition < 0 ? PinnedExpandableHeaderAdapter.PINNED_HEADER_VISIBLE
				: mAdapter.getPinnedExpandableHeaderState(groupPosition, childPosition);
