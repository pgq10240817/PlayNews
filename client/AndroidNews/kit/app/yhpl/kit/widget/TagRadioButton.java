...
/**
 * Author: wangjie Email: tiantian.china.2@gmail.com Date: 9/19/14.
 */
public class TagRadioButton extends RadioButton {
	...
	protected void onDraw(Canvas canvas) {
		...
		if (shouldShowTag) {
			...
			// ABTextUtil.dip2px(getContext(), 4), paint);
			...
			if (!ABTextUtil.isEmpty(drawables) && drawables.length > 2) {
				...
				// setCompoundDrawables(null, new BitmapDrawable(drawableBm),
				// null, null);
				// shouldShowTag = false;

				// Logger.d(TAG, "drawBm width: " + drawBm.getWidth() +
				// ", height: " + drawBm.getHeight());
				...
				// ABShape.generateCornerShapeDrawable(Color.parseColor("#ffffff"),
				// ABTextUtil.dip2px(getContext(), 5));
