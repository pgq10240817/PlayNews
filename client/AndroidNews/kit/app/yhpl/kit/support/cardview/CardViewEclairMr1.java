...
/**
 * Author: wangjie Email: tiantian.china.2@gmail.com Date: 12/15/14.
 */
class CardViewEclairMr1 implements CardViewImpl {
	...
	public void initStatic() {
		...
		// canvas.drawRoundRect before JBMR1 because API 11-16 used alpha mask
		// textures to draw
		// shapes.
	...
	@Override
	public void initialize(CardViewDelegate cardView, Context context, int backgroundColor, float radius,
