...
class RoundRectDrawableWithShadow extends Drawable {
	...
	/*
	 * This helper is set by CardView implementations. <p> Prior to API 17,
	 * canvas.drawRoundRect is expensive; which is why we need this interface to
	 * draw efficient rounded rectangles before 17.
	 */
	...
	private void buildShadowCorners() {
		...
		// we offset the content shadowSize/2 pixels up to make it more
		// realistic.
