package app.yhpl.kit.support.recyclerview.pinnedlayout;
...
import app.yhpl.kit.support.recyclerview.layoutmanager.ABaseLinearLayoutManager;
import app.yhpl.kit.support.recyclerview.listener.OnRecyclerViewScrollListener;

/**
 * Author: wangjie Email: tiantian.china.2@gmail.com Date: 2/2/15.
 */
public class PinnedRecyclerViewLayout extends RelativeLayout {
	...
	public void initRecyclerPinned(RecyclerView recyclerView, ABaseLinearLayoutManager layoutManager, View pinnedView) {
		...
		layoutManager.getRecyclerViewScrollManager().addScrollListener(recyclerView,
