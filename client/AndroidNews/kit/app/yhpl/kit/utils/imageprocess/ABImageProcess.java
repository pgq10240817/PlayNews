...
import app.yhpl.kit.utils.ABIOUtil;
import app.yhpl.kit.utils.ABViewUtil;
import app.yhpl.kit.utils.imageprocess.blur.FastBlur;

/**
 * Created with IntelliJ IDEA. Author: wangjie email:tiantian.china.2@gmail.com
 * Date: 14-3-28 Time: 上午10:12
 */
public class ABImageProcess {
	...
	public static Bitmap getCompressedImage(String srcPath, float ww, float hh, int size) {
		...
		try {
			...
			resultBm = BitmapFactory.decodeStream(commpressedBm, // 缩小到指定容量
