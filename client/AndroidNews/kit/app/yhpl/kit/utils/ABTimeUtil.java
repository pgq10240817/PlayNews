...
public class ABTimeUtil {
	...
	public static String millisToStringMiddle(long millis, boolean isWhole, boolean isFormat, String hUnit,
			String mUnit, String sUnit) {
		String h = "";
		String m = "";
		String s = "";
		if (isWhole) {
	...
	/**
	 * 时间格式： 1小时内用，多少分钟前； 超过1小时，显示时间而无日期； 如果是昨天，则显示昨天 超过昨天再显示日期； 超过1年再显示年。
	 *
	 * @param millis
	 * @return
	 */
	...
	/**
	 * 时间格式： 今天，显示时间而无日期； 如果是昨天，则显示昨天 超过昨天再显示日期； 超过1年再显示年。
	 *
	 * @param millis
	 * @return
	 */
	...
	public static long getTodayStartMillis() {
		// String dateStr = millisToStringDate(System.currentTimeMillis(),
		// "yyyy-MM-dd");
