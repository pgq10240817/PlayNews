...
public abstract class HippoHttpRequest<T> extends HippoRequest<T> {
	 ...
	 */
	public HippoHttpRequest(int method, String url, NameValuePair[] headers, byte[] body, RequestListener<T> listener,
	...
	public HippoHttpRequest(int method, String url, NameValuePair[] headers, byte[] body, RequestListener<T> listener,
			HippoResponse.ErrorListener errorListener, int retryCount) {
