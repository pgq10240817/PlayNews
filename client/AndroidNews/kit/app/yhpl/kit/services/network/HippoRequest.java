...
import app.yhpl.kit.services.network.exception.RetryFailedException;
...
public abstract class HippoRequest<T> implements Comparable<HippoRequest>, CancelableTask {
	...
	public String toString() {
		return "HippoRequest{" + "seq=" + seq + ", retryPolicy=" + retryPolicy + ", state=" + state + ", listener="
