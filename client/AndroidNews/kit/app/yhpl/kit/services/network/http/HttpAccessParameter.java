...
import app.yhpl.kit.services.BaseAccessParameter;
...
public class HttpAccessParameter extends BaseAccessParameter {
	...
	public NameValuePair[] getHeadNameValuePairs() {
		return headNameValuePairList != null ? headNameValuePairList.toArray(new NameValuePair[headNameValuePairList
				.size()]) : null;
	}
