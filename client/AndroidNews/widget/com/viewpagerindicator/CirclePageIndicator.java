...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRadius = a.getDimension(R.styleable.CirclePageIndicator_radiusPageIndicator, defaultRadius);
        mSnap = a.getBoolean(R.styleable.CirclePageIndicator_snapPageIndicator, defaultSnap);
