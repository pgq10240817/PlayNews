...
public class TitlePageIndicator extends View implements PageIndicator {
	...
	public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
		...
		mFooterLineHeight = a.getDimension(R.styleable.TitlePageIndicator_footerLineHeightPageIndicator,
		...
		mTitlePadding = a.getDimension(R.styleable.TitlePageIndicator_titlePaddingPageIndicator, defaultTitlePadding);
		mClipPadding = a.getDimension(R.styleable.TitlePageIndicator_clipPaddingPageIndicator, defaultClipPadding);
		mColorSelected = a.getColor(R.styleable.TitlePageIndicator_selectedColor, defaultSelectedColor);
		mColorText = a.getColor(R.styleable.TitlePageIndicator_android_textColor, defaultTextColor);
		mBoldText = a.getBoolean(R.styleable.TitlePageIndicator_selectedBoldPageIndicator, defaultSelectedBold);

		final float textSize = a.getDimension(R.styleable.TitlePageIndicator_android_textSize, defaultTextSize);
		final int footerColor = a.getColor(R.styleable.TitlePageIndicator_footerColorPageIndicator, defaultFooterColor);
