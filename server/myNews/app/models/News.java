...
public class News extends Model {
	...
	public static Page<News> page(int page, int pageSize, String cid) {
	...
	public static News getNewsWithId(String id) {
		if (TextUtil.isEmpty(id)) {
			return null;
		} else {
			return find.where().ieq("id", id).findUnique();
		}
	}

	@Override
	public String toString() {
		return "News [id=" + id + ", title=" + title + ", cid=" + cid + ", extra=" + extra + "]";
	}
